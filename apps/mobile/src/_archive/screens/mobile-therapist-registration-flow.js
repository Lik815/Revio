...
import { ComplianceStatusStep } from '../../components/ComplianceStatusStep';
...
export function TherapistRegistrationFlow({
  ...
  return (
    ...
    <ScrollView
      ...
      contentContainerStyle={[styles.scrollContent, { paddingHorizontal: 20, paddingTop: 0, paddingBottom: 56, gap: SPACE.sm }]}
